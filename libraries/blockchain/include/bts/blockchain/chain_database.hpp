   ...
   class chain_database : public chain_interface, public std::enable_shared_from_this<chain_database>
   {
      public:
        ...
        virtual map<object_id_type, map<string, edge_record>>
         ...
         map<address, share_type>          compute_snapshot()const;
         map<address, share_type>          compute_snapshot(const asset_id_type& asset_id)const;
         map<address, share_type>          compute_claimed_snapshot()const;
